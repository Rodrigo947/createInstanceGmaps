        ...
        if(sfMin<=sfMax){
            ...
            for (i = sfMin; i <= sfMax; i++) {
                ...
                if(i==sfMin){
                    ...
                    cell0.innerHTML = "<input type='number' class='form-control' style='vertical-align: middle;' value='125'>"
                ...
                cell1.innerHTML = i
                cell2.innerHTML = "<input type='number' id=sens"+i+" class='form-control' value='"+matrizSensibilidade[i]+"' >"
                cell3.innerHTML = calcAlcanceMaximo(matrizSensibilidade[i],parseInt($("#dbmMin").val()),parseFloat($("#dbi").val()))
                cell4.innerHTML = calcAlcanceMaximo(matrizSensibilidade[i],parseInt($("#dbmMax").val()),parseFloat($("#dbi").val()))
                j++
            }
            criarMatrizAlcance()
        }
